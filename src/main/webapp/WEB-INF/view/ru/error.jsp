...
<html>
    <head>
        ...
        <meta charset="utf-8" />
        <meta name="description" content="UpSkillPAY - ошибка аутентификации" />
        ...
        <title>Ошибка аутентификации - UpSkillPAY</title>
    </head>
    <body>
        <div class="container">
            <br />
        ...
        <div class="container">
            ...
            <div class="alert alert-danger" role="alert">
                Ошибка аутентификации. Проверьте введенные учетные данные!
            </div>
        </div>
        <br />
    </body>
