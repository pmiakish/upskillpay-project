...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <br />
            <br /><h3>Редактировать профиль администратора:</h3><br />
            <br />
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" id="selectRole" name="role">
                            <option value="ADMIN"<c:if test="${admin.role == 'ADMIN'}"> selected</c:if>>Администратор</option>
                            <option value="SUPERADMIN"<c:if test="${admin.role == 'SUPERADMIN'}"> selected</c:if>>Главный администратор</option>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputFirstName" pattern="[A-ZА-Я][\-A-Za-zА-Яа-я ]+"
                               maxlength="30" value="${admin.firstName}" name="firstName" required />
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputLastName" pattern="[A-ZА-Я][\-A-Za-zА-Яа-я ]+"
                               maxlength="30" value="${admin.lastName}" name="lastName" required />
                    </div>
                </div>
                <div class="mb-3 row">
