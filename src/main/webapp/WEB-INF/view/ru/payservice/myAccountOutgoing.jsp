...
<html>
    <head>
        <meta charset="utf-8" />
        <meta name="description" content="UpSkillPAY - расходные операции со счетом клиента" />
        ...
        <title>Расходные операции<c:if test="${account != null}"> (счет ${account.id})</c:if> - UpSkillPAY</title>
    </head>
    <body>
        <div class="container">
            <br />
        ...
        <div class="container">
            ...
            <c:if test="${account != null}">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/payservice/my_account_outgoing/${account.id}">Расходные операции</a>
                    </li>
                </ul>
                <table class="table">
                ...
                <div class="container">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th scope="col">
                                <project:sortlink page="${page}" endpoint="/payservice/my_account_outgoing/${account.id}"
                                                  target="receiver" description="Счет получателя" />
                            </th>
                            <th scope="col">
                                <project:sortlink page="${page}" endpoint="/payservice/my_account_outgoing/${account.id}"
