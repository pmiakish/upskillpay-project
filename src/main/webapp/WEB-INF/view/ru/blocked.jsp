...
<html>
    <head>
        <meta charset="utf-8" />
        <meta name="description" content="UpSkillPAY - доступ запрещен" />
        ...
        <title>Доступ запрещен - UpSkillPAY</title>
    </head>
    <body>
        <div class="container">
            <br />
            ...
            <div class="alert alert-danger" role="alert">
                <p><strong>Ваш профиль был заблокирован!</strong></p>
                <p>Для разблокировки обратитесь к отествтвенному администратору.</p>
            </div>
        </div>
    </body>
</html>