...
<html>
    <head>
        <meta charset="utf-8" />
        <meta name="description" content="UpSkillPAY - customer's account outgoing payments" />
        ...
        <title>Outgoing payments<c:if test="${account != null}"> (account ${account.id})</c:if> - UpSkillPAY</title>
    </head>
    <body>
        <div class="container">
            <br />
        ...
        <div class="container">
            ...
            <c:if test="${account != null}">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/payservice/my_account_outgoing/${account.id}">Outgoing payments</a>
                    </li>
                </ul>
                <table class="table">
                ...
                <div class="container">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <th scope="col">
                                <project:sortlink page="${page}" endpoint="/payservice/my_account_outgoing/${account.id}"
                            ...
                            <th scope="col">
                                <project:sortlink page="${page}" endpoint="/payservice/my_account_outgoing/${account.id}"
                                                  target="receiver" description="Receiver's account" />
                            </th>
                            <th scope="col">
                                <project:sortlink page="${page}" endpoint="/payservice/my_account_outgoing/${account.id}"
                ...
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <project:pagination page="${page}" endpoint="/payservice/my_account_outgoing/${account.id}" />
                        </div>
                        <div class="col-2">
                            <form method="GET" action="/payservice/my_account_outgoing/${account.id}">
