...
public class CardsServlet extends HttpServlet {
    ...
    private static final Logger logger = LogManager.getLogger(CardsServlet.class.getName());
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            if (id.isPresent() && currentStatus.isPresent()) {
                boolean updated = adminService.updateCardStatus(
                        id.get(),
                ...
                logger.log(Level.WARN, String.format("Cannot update card status (bad parameters) [id: %s, " +
            ...
            logger.log(Level.ERROR, String.format("Cannot update card status (exception was thrown) [id: %s, " +
    ...
    private void sendUpdateError(HttpServletRequest req, HttpServletResponse resp, RequestDispatcher view,
        ...
        try {
            ...
            buildErrorMessage(req, String.format("Cannot build cards page (%s). ", e.getMessage()));
            logger.log(Level.ERROR, String.format("Cannot build cards page (uri: %s)", req.getRequestURI()), e);
        }
        view.forward(req, resp);
    }
